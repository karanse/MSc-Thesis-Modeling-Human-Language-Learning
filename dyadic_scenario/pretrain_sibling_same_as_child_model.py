...
#
torch.save(listener.state_dict(), 'pretrained_sibling_models/{}_{}_{}_checkpoint_sibling_listener.pth'.format(str(batchsize),lr, str(epochs)))
torch.save(speaker.state_dict(), 'pretrained_sibling_models/{}_{}_{}_checkpoint_sibling_speaker.pth'.format(str(batchsize),lr,str(epochs)))
...
torch.save({
            ...
            }, 'pretrained_sibling_models/{}_{}_{}_checkpoint_sibling_listener.pth'.format(str(batchsize),lr,str(epochs)))
...
torch.save({
            ...
            }, 'pretrained_sibling_models/{}_{}_{}_checkpoint_sibling_speaker.pth'.format(str(batchsize),lr,str(epochs)))
