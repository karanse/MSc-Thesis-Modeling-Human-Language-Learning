...
############### Child evaluation ##############################################
        ...
        if batch % printerval == 0:
            print('| epoch {:2d} | batch {:3d}/{:3d} | t {:6.2f} | l.S.L {:6.4f} | l.S.A {:5.4f} | s.S.L {:6.4f} | s.S.A {:5.4f} | l.C.L {:6.4f} | l.C.A {:5.4f} | s.C.L {:6.4f} | s.C.A {:5.4f} |'.format(
    ...
    if split == 'val':
        ...
        print('| L.S.loss {:8.4f} | L.S.acc. {:8.4f} | L.C.loss {:8.4f} | L.C.acc. {:8.4f} |'.format(
        ...
        print('| S.S.loss {:8.4f} | S.S.acc. {:8.4f} | S.C.loss {:8.4f} | S.C.acc. {:8.4f} |'.format(
            ...
            avg_sp_eval_child_acc))
        print('-' * 89)
    return avg_li_eval_sibling_loss, avg_li_eval_sibling_acc, avg_li_eval_child_loss, avg_li_eval_child_acc, avg_sp_eval_sibling_loss, avg_sp_eval_sibling_acc, avg_sp_eval_child_loss, avg_sp_eval_child_acc
...
################ child training ###############################################
    ...
    print('-' * 89)
    return avg_li_train_sibling_loss, avg_li_train_sibling_acc, avg_li_train_child_loss, avg_li_train_child_acc, avg_sp_train_sibling_loss, avg_sp_train_sibling_acc, avg_sp_train_child_loss, avg_sp_train_child_acc
...
checkpoint = torch.load('40_0.001_checkpoint_sibling_listener.pth')
...
checkpoint = torch.load('40_0.001_checkpoint_sibling_speaker.pth')
...
#epoch = checkpoint['epoch']
speaker_sibling_loss = checkpoint['loss']
...
listener_train_sibling_loss = np.empty(20)
listener_train_sibling_acc = np.empty(20)
speaker_train_sibling_loss = np.empty(20)
speaker_train_sibling_acc = np.empty(20)
listener_val_sibling_loss = np.empty(20)
listener_val_sibling_acc = np.empty(20)
speaker_val_sibling_loss = np.empty(20)
speaker_val_sibling_acc = np.empty(20)
listener_test_sibling_loss = np.empty(20)
listener_test_sibling_acc = np.empty(20)
speaker_test_sibling_loss = np.empty(20)
speaker_test_sibling_acc = np.empty(20)



# Creating numpy arrays to store loss and accuracy
# for train, validation, and test splits -- CHILD
listener_train_child_loss = np.empty(20)
listener_train_child_acc = np.empty(20)
speaker_train_child_loss = np.empty(20)
speaker_train_child_acc = np.empty(20)
listener_val_child_loss = np.empty(20)
listener_val_child_acc = np.empty(20)
speaker_val_child_loss = np.empty(20)
speaker_val_child_acc = np.empty(20)
listener_test_child_loss = np.empty(20)
listener_test_child_acc = np.empty(20)
speaker_test_child_loss = np.empty(20)
speaker_test_child_acc = np.empty(20)
...
try:
    for epoch in range(1, epochs+1):
        ...
        li_train_sibling_loss, li_train_sibling_acc, li_train_child_loss, li_train_child_acc, sp_train_sibling_loss, sp_train_sibling_acc, sp_train_child_loss, sp_train_child_acc = train()
...
#        li_train_loss, li_train_acc, sp_train_loss, sp_train_acc = train()
        ...
        li_val_sibling_loss, li_val_sibling_acc, li_val_child_loss, li_val_child_acc, sp_val_sibling_loss, sp_val_sibling_acc, sp_val_child_loss, sp_val_child_acc = evaluate(epoch)
...
#        li_test_loss, li_test_acc, sp_test_loss, sp_test_acc 
        li_test_sibling_loss, li_test_sibling_acc, li_test_child_loss, li_test_child_acc, sp_test_sibling_loss, sp_test_sibling_acc, sp_test_child_loss, sp_test_child_acc= evaluate(epoch,'test')
